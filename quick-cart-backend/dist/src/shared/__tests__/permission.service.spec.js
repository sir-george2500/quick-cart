...
describe("PermissionService", () => {
    ...
    describe("hasPermission", () => {
        ...
        it("should return false when user lacks permission", () => {
            ...
            expect(service.hasPermission(user, Permission.VENDOR_APPROVE)).toBe(false);
        });
        it("should return true for super admin regardless of permission", () => {
            ...
            expect(service.hasPermission(user, Permission.COMMISSION_CONFIGURE)).toBe(true);
        });
    ...
    describe("getUserPermissions", () => {
        ...
        it("should not duplicate permissions", () => {
            ...
            const permissions = service.getUserPermissions(user);
            const productCreateCount = permissions.filter((p) => p === Permission.PRODUCT_CREATE).length;
