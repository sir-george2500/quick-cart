...
// Get all users
export const getAllUsers = async (req: Request, res: Response): Promise<void | Response> => {
    try {
...
export const updateUserByEmail = async (req: Request, res: Response): Promise<void | Response> => {
    try {
...
export const addDeliveryAddress = async (req: Request, res: Response): Promise<void | Response> => {
    try {
        const userEmail = req.params.email;
...
// Update user address
export const updateAddressById = async (req: Request, res: Response): Promise<void | Response> => {
    try {
...
// Remove user address
export const removeAddressById = async (req: Request, res: Response): Promise<void | Response> => {
    try {
        const addressId = parseInt(req.params.addressId);
...
export const verifyOtpAndResetPassword = async (req: Request, res: Response): Promise<void | Response> => {
    try {
...
export const resendSecurityCode = async (req: Request, res: Response): Promise<void | Response> => {
    try {
        const { email } = req.body;
        const user = await prisma.user.findUnique({ where: { email } });
...
// Delete user by ID
export const deleteUserById = async (req: Request, res: Response): Promise<void | Response> => {
    try {
