...
export const getCartItems = async (req: Request, res: Response): Promise<void | Response> => {
  try {
...
export const createCartItem = async (req: Request, res: Response): Promise<void | Response> => {
...
export const deleteCartItem = async (req: Request, res: Response): Promise<void | Response> => {
  try {
...
export const deleteCartItems = async (req: Request, res: Response): Promise<void | Response> => {
  try {
