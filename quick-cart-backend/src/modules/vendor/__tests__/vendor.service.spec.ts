...
describe("VendorService", () => {
  ...
  describe("createVendor", () => {
    it("should create vendor with instant activation", async () => {
      ...
      prismaMock.vendor.create.mockResolvedValue(expectedVendor as any);
  ...
  describe("getVendorProfile", () => {
    it("should return vendor profile by userId", async () => {
      ...
      prismaMock.vendor.findUnique.mockResolvedValue(mockVendor as any);
  ...
  describe("updateVendor", () => {
    ...
    it("should enforce ownership - vendor can only update own profile", async () => {
      ...
      await expect(
        vendorService.updateVendor("wrong-user-id", updateData)
      ).rejects.toThrow("Not authorized to update this vendor profile");
    });
  });
  ...
  describe("getVendorStats", () => {
    it("should return vendor statistics", async () => {
      ...
      prismaMock.vendor.findUnique.mockResolvedValue(mockStats as any);
  ...
  describe("Admin Functions", () => {
    describe("verifyVendor", () => {
      it("should mark vendor as verified and set timestamp", async () => {
        ...
        prismaMock.vendor.update.mockResolvedValue(verifiedVendor as any);
